...
import Apartment_2 from "../../assets/villa.jpeg";
import Spaces from "../../assets/plot.jpeg";
import Villas from "../../assets/flat.jpeg";
import Complex from "../../assets/Gated-communities.jpeg";
...
const projects = [
  {
    ...
    type: "Aishwarya Lakshmi Residency",
    description:
...
>
                ...
                <SwiperSlide key={index}>
                  ...
                  >
                    <div className="banner-content">
                      <h1>{item.title}</h1>
                      <p>{item.desc}</p>
                       {/* <button className='cmplt-ban-btn'>
            ...
            <div className='upc-intrd-sec'>
                <h1>Projects We’ve Successfully Delivered</h1>
                <p>Take a look at our completed projects that showcase our expertise in delivering high-quality developments. From thoughtful design to durable construction, each project reflects our commitment to excellence and customer satisfaction.</p>
            </div>
            <div className="upc-prj-cards">
              {projects.map((project, index) => (
                  ...
                  <span className="card-view">
                      <Link to={`/completed/${project.id}`} className="card-view">
                            <p>View</p>
                      </Link>
                      <svg
                      xmlns="http://www.w3.org/2000/svg"
